...
from .views import (
    ...
    GroupStatusViewSet,
    ClassroomViewSet, ScheduleTypeViewSet, GroupViewSet, DepartmentViewSet, PaymentMethodViewSet,
    PaymentViewSet, StudentViewSet, StudentOnStudyViewSet, AdvertisingSourceViewSet, RequestStatusViewSet,
    ReasonViewSet, DepartmentImageUpdateViewSet,
    StudentStatusAViewSet, StudentStatusBViewSet, StudentStatusCViewSet, StudentStatusDViewSet,
    StudentOnStudyFilterAViewSet, StudentOnStudyFilterBViewSet, StudentOnStudyFilterCViewSet,
    StudentOnStudyFilterDViewSet, StudentOnStudyFilterEViewSet, StudentOnStudyFilterFViewSet,
    StudentOnStudyFilterGViewSet, StudentOnStudyFilterHViewSet,
)
